...
def q_1_4():
    ...
    return [
        ...
        {'id':4,'type':'multiple_choice','question':'Se você olhar a ponta de um lápis comum de cima, sem ser o redondo, qual figura geométrica aparece?',
         'figure':None,'options':['Triângulo','Quadrado','Hexágono Regular','Círculo'],'correct':2,
         'explanation':'A maioria dos lápis tem o corpo em formato de Hexágono Regular — 6 lados iguais, que evitam que ele role para longe da mesa!','xp':10},
    ...
    return [
        {'id':1,'type':'drag_drop',
         ...
         'targets':[
             ...
             {'id':'altura','text':'Distância em linha reta, formando um ângulo de 90°, entre a base e o lado ou vértice oposto','correct':'Altura'},
        ...
        {'id':2,'type':'drag_drop',
         ...
         'items':['Círculo','Losango','Trapézio'],
         'targets':[
             {'id':'ci','text':'Possui raio e diâmetro, que é o dobro do raio','correct':'Círculo'},
             {'id':'rh','text':'Possui uma diagonal maior e uma diagonal menor','correct':'Losango'},
             {'id':'tp','text':'Possui uma base maior e uma base menor','correct':'Trapézio'},
         ],'explanation':'Losango→diagonais; Trapézio→duas bases; Círculo→raio.','xp':15},
        {'id':3,'type':'drag_drop',
         'question':'Associe cada definição ao elemento correto',
         'items':['Lado','Diagonal maior','Base maior'],
         'targets':[
             {'id':'sq','text':'Medida de um dos lados iguais do quadrado','correct':'Lado'},
             {'id':'rh','text':'A maior das duas diagonais do losango','correct':'Diagonal maior'},
             {'id':'tp','text':'O lado mais longo e paralelo ao outro no trapézio','correct':'Base maior'},
        ...
        {'id':4,'type':'drag_drop',
         ...
         'items':['Vértice','Ângulo reto','Lado igual ao oposto'],
         'targets':[
             {'id':'tr','text':'Ponto onde dois lados do triângulo se encontram','correct':'Vértice'},
             {'id':'re','text':'Característica de todos os ângulos do retângulo, que medem 90°','correct':'Ângulo reto'},
        ...
        {'id':5,'type':'drag_drop',
         ...
         'targets':[
             ...
             {'id':'c0','text':'0 lados, é uma curva fechada','correct':'Círculo'},
    ...
    return [
        ...
        {'id':3,'type':'drag_drop',
         ...
         'targets':[
             ...
             {'id':'c4b','text':'4 lados iguais','correct':'Losango'},
        ...
        {'id':4,'type':'drag_drop',
         ...
         'targets':[
             ...
             {'id':'c4d','text':'4 lados, com um par paralelo','correct':'Trapézio'},
        ...
        {'id':5,'type':'drag_drop',
         ...
         'targets':[
             ...
             {'id':'c4e','text':'4 lados iguais','correct':'Losango'},
...
def q_2_5():
    ...
    return [
        {'id':1,'type':'multiple_choice','question':'Qual das opções DESCREVE CORRETAMENTE o Losango?',
         'figure':'rhombus',
         'options':['4 lados iguais e 4 ângulos retos, todos de 90°','4 lados iguais, mas com ângulos oblíquos','3 lados iguais e 3 ângulos de 60° cada','4 lados desiguais e apenas um par paralelo'],
        ...
        {'id':2,'type':'multiple_choice','question':'Qual das opções DESCREVE CORRETAMENTE o Trapézio?',
         'figure':'trapezoid',
         'options':['4 lados iguais e 4 ângulos retos','3 lados retos e 3 vértices','4 lados, com apenas 1 par de lados paralelos','6 lados iguais e 6 vértices'],
        ...
        {'id':3,'type':'multiple_choice','question':'Qual das opções DESCREVE CORRETAMENTE o Triângulo Equilátero?',
         ...
         'options':['3 lados retos, todos de medidas diferentes','3 lados iguais e 3 ângulos de 60° cada','3 lados retos e 4 vértices arredondados','3 lados retos com um ângulo de 90°'],
        ...
        {'id':4,'type':'multiple_choice','question':'Qual das opções DESCREVE CORRETAMENTE o Círculo?',
         'figure':'circle',
         'options':['Figura fechada com 4 lados curvos e iguais','Todos os pontos ficam à mesma distância do centro','Figura fechada com 6 lados arredondados','Figura fechada com 3 vértices arredondados'],
         'correct':1,'explanation':'O Círculo é uma figura plana fechada. Todos os seus pontos estão à mesma distância do centro — essa distância é o raio.','xp':10},
        {'id':5,'type':'multiple_choice','question':'Qual das opções DESCREVE CORRETAMENTE o Hexágono Regular?',
         'figure':'hexagon',
         'options':['5 lados iguais e 5 ângulos de 108° cada','6 lados iguais e 6 ângulos de 120° cada','6 lados desiguais e sem simetria','4 lados retos e duas diagonais iguais'],
...
def q_3_1():
    ...
    return [
        {'id':1,'type':'fill_blank','question':'A fórmula da área do Quadrado é A = l ___, onde l é o lado.\nDigite apenas o número do expoente que falta.',
        ...
        {'id':2,'type':'fill_blank','question':'A fórmula da área do Triângulo é A = (b × h) / ___, onde b é a base e h é a altura.\nDigite apenas o número que falta.',
        ...
        {'id':3,'type':'fill_blank','question':'A fórmula da área do Círculo é A = ___ × r², onde r é o raio.\nDigite o nome da constante, em letras — ex: pi.',
        ...
        {'id':4,'type':'fill_blank','question':'A fórmula da área do Retângulo é A = b × ___, onde b é a base.\nDigite apenas a letra que falta.',
         'figure':'rectangle','answer':'h','hint':'O outro elemento além da base é a...',
         'explanation':'A = b × h, base vezes altura. No retângulo, base e altura formam um ângulo reto de 90° entre si.','xp':10},
        {'id':5,'type':'fill_blank','question':'A fórmula da área do Trapézio é A = ((B + b) × h) / ___, onde B é a base maior, b é a base menor e h é a altura.\nDigite apenas o número que falta.',
...
def q_3_3():
    ...
    return [
        {'id':1,'type':'multiple_choice','question':'Qual fórmula está ERRADA para a área do Quadrado, sendo l o lado?',
         'figure':'square','options':['A = l²','A = l × l','A = l³','A = lado²'],'correct':2,
         'explanation':'A = l³ está errada porque eleva o lado ao cubo, o que dá um volume, não uma área. A área é sempre l², não l³.','xp':10},
        {'id':2,'type':'multiple_choice','question':'Qual fórmula está ERRADA para a área do Triângulo, sendo b a base e h a altura?',
        ...
        {'id':3,'type':'multiple_choice','question':'Qual fórmula está ERRADA para a área do Círculo, sendo r o raio?',
        ...
        {'id':4,'type':'multiple_choice','question':'Qual fórmula está ERRADA para a área do Losango, sendo D e d as diagonais?',
         'figure':'rhombus','options':['A = (D × d) / 2','A = D × d / 2','A = D + d','A = (D × d) ÷ 2'],'correct':2,
         'explanation':'A = D + d está errada! Somamos as diagonais apenas no trapézio, para achar as bases. No losango, multiplicamos: A = (D × d) / 2.','xp':10},
        {'id':5,'type':'multiple_choice','question':'Qual fórmula está ERRADA para a área do Trapézio, sendo B e b as bases e h a altura?',
...
def q_3_4():
    ...
    return [
        ...
        {'id':2,'type':'order_steps','question':'Ordene as etapas para calcular a área do RETÂNGULO com base b = 8 cm e altura h = 5 cm',
         'figure':'rectangle',
        ...
        {'id':3,'type':'order_steps','question':'Ordene as etapas para calcular a área do TRIÂNGULO com base b = 10 cm e altura h = 6 cm',
         'figure':'triangle',
        ...
        {'id':4,'type':'order_steps','question':'Ordene as etapas para calcular a área do TRAPÉZIO com base maior B = 12 cm, base menor b = 8 cm e altura h = 5 cm',
         'figure':'trapezoid',
        ...
        {'id':5,'type':'order_steps','question':'Ordene as etapas para calcular a área do CÍRCULO com raio r = 4 cm',
         'figure':'circle',
...
def q_3_5():
    ...
    return [
        ...
        {'id':2,'type':'multiple_choice','question':'Na fórmula do Trapézio A = ((B + b) × h) / 2, o que são "B" e "b"?',
         'figure':'trapezoid','options':['Dois triângulos internos','As duas bases paralelas do trapézio','Diagonal maior e diagonal menor','Base e altura'],'correct':1,
...
def q_4_1():
    """Atividade 4.1 – Cálculo guiado com dica (fill-blank) — uma questão por figura, baseadas em IFRN"""
    return [
        {'id':1,'type':'fill_blank',
         'question':'IFRN — RETÂNGULO com base = 24 m e altura = 12,5 m\nFórmula: A = b × h = 24 × 12,5 = ?\nQual é a área em m²?',
         'figure':'rectangle','answer':'300','hint':'24 × 12,5 = ?',
         'explanation':'A = b × h = 24 × 12,5 = 300 m² — questão adaptada do IFRN','xp':10},
        {'id':2,'type':'fill_blank',
         'question':'TRIÂNGULO com base = 15 cm e altura = 7,5 cm\nFórmula: A = (b × h) / 2 = (15 × 7,5) / 2 = ?\nQual é a área em cm²?',
         'figure':'triangle','answer':'56.25','hint':'15 × 7,5 = 112,5 → 112,5 ÷ 2 = ?',
         'explanation':'A = (b × h) / 2 = (15 × 7,5) / 2 = 112,5 / 2 = 56,25 cm²','xp':10},
        {'id':3,'type':'fill_blank',
         'question':'LOSANGO com diagonal maior D = 37 cm e diagonal menor d = 24 cm\nFórmula: A = (D × d) / 2 = (37 × 24) / 2 = ?\nQual é a área em cm²?',
         'figure':'rhombus','answer':'444','hint':'37 × 24 = 888 → 888 ÷ 2 = ?',
         'explanation':'A = (D × d) / 2 = (37 × 24) / 2 = 888 / 2 = 444 cm²','xp':10},
        {'id':4,'type':'fill_blank',
         'question':'TRAPÉZIO com base maior B = 20 cm, base menor b = 12 cm e altura h = 5 cm\nFórmula: A = ((B + b) × h) / 2 = ((20 + 12) × 5) / 2 = ?\nQual é a área em cm²?',
         'figure':'trapezoid','answer':'80','hint':'(20 + 12) = 32 → 32 × 5 = 160 → 160 ÷ 2 = ?',
         'explanation':'A = ((20 + 12) × 5) / 2 = (32 × 5) / 2 = 160 / 2 = 80 cm²','xp':10},
        {'id':5,'type':'fill_blank',
         'question':'CÍRCULO com raio = 4 cm. Use π ≈ 3,14.\nFórmula: A = π × r² = 3,14 × 4² = 3,14 × 16 = ?\nQual é a área em cm²?',
         'figure':'circle','answer':'50.24','hint':'3,14 × 16 = ?',
         'explanation':'A = π × r² = 3,14 × 4² = 3,14 × 16 = 50,24 cm²','xp':10},
    ]


def q_4_2():
    """Atividade 4.2 – Cálculo direto sem auxílio (fill-blank) — exercícios da lista por figura"""
    return [
        {'id':1,'type':'fill_blank',
         'question':'Calcule a área do RETÂNGULO com base = 8 cm e altura = 3,5 cm.',
         'figure':'rectangle','answer':'28','hint':'Fórmula: A = b × h',
         'explanation':'A = b × h = 8 × 3,5 = 28 cm²','xp':12},
        {'id':2,'type':'fill_blank',
         'question':'IFRN — Um terreno retangular tem 15 m de frente por 31,2 m de fundo.\nQual é a área desse terreno em m²?',
         'figure':'rectangle','answer':'468','hint':'Fórmula: A = b × h',
         'explanation':'A = b × h = 15 × 31,2 = 468 m²  (IFRN)','xp':12},
        {'id':3,'type':'fill_blank',
         'question':'Num triângulo, a medida da base é 30 cm e a altura é 1/6 da base.\nQual é a área em cm²?',
         'figure':'triangle','answer':'75','hint':'Passo 1: altura = 30 ÷ 6 = 5 cm. Passo 2: A = (30 × 5) / 2',
         'explanation':'Altura = 30 ÷ 6 = 5 cm. A = (30 × 5) / 2 = 150 / 2 = 75 cm²','xp':12},
        {'id':4,'type':'fill_blank',
         'question':'As diagonais de um losango medem 6,2 cm e 8 cm.\nQual é a área do losango em cm²?',
         'figure':'rhombus','answer':'24.8','hint':'Fórmula: A = (D × d) / 2',
         'explanation':'A = (6,2 × 8) / 2 = 49,6 / 2 = 24,8 cm²','xp':12},
        {'id':5,'type':'fill_blank',
         'question':'Um piso trapezoidal tem base maior de 11 m, base menor de 7,40 m e altura de 6,50 m.\nQual é a área em m²?',
         'figure':'trapezoid','answer':'59.8','hint':'Fórmula: A = ((B + b) × h) / 2',
         'explanation':'A = ((11 + 7,4) × 6,5) / 2 = (18,4 × 6,5) / 2 = 119,6 / 2 = 59,8 m²','xp':12},
    ]


def q_4_3():
    """Atividade 4.3 – Problemas contextualizados (fill-blank) — IFRN e situações reais"""
    return [
        {'id':1,'type':'fill_blank',
         'question':'IFRN — Um terreno retangular tem 8,4 m por 15 m e está sendo gramado.\nSabendo que 1 kg de semente cobre 3 m², quantos quilos são necessários?',
         'figure':'rectangle','answer':'42','hint':'Passo 1: Área = 8,4 × 15. Passo 2: kg = Área ÷ 3',
         'explanation':'Área = 8,4 × 15 = 126 m². kg = 126 ÷ 3 = 42 kg  (IFRN)','xp':12},
        {'id':2,'type':'fill_blank',
         'question':'IFRN — Para ladrilhar uma parede de 27 m² foram usadas peças quadradas de 15 cm de lado.\nQuantas peças foram usadas?',
         'figure':'square','answer':'1200','hint':'Passo 1: 15 cm = 0,15 m → área da peça = 0,15². Passo 2: peças = 27 ÷ área da peça',
         'explanation':'Peça: 0,15² = 0,0225 m². Peças = 27 ÷ 0,0225 = 1200 peças  (IFRN)','xp':12},
        {'id':3,'type':'fill_blank',
         'question':'Um marceneiro fez 6 chapas triangulares para fixar em uma parede,\ncada uma com base = 45 cm e altura = 26 cm.\nQual é a área total das 6 chapas em cm²?',
         'figure':'triangle','answer':'3510','hint':'Área de 1 chapa = (45 × 26) / 2. Depois × 6.',
         'explanation':'1 chapa: (45 × 26) / 2 = 585 cm². 6 chapas: 585 × 6 = 3510 cm²','xp':12},
        {'id':4,'type':'fill_blank',
        ...
        {'id':5,'type':'fill_blank',
         'question':'IFRN — Você vai forrar com carpete uma sala de 4,5 m por 3,5 m.\nO m² do carpete colocado custa R$ 17,00. Qual é o gasto total?',
         'figure':'rectangle','answer':'267.75','hint':'Passo 1: Área = 4,5 × 3,5. Passo 2: custo = Área × 17',
         'explanation':'Área = 4,5 × 3,5 = 15,75 m². Custo = 15,75 × R$17,00 = R$267,75  (IFRN)','xp':12},
    ]


def q_4_4():
    """Atividade 4.4 – Problemas com múltiplas etapas (fill-blank) — IFRN, IFSP e derivados"""
    return [
        {'id':1,'type':'fill_blank',
         'question':'IFRN — Determine a área de um retângulo com 46 cm de perímetro,\nsabendo que o comprimento excede em 7 cm a largura.\nÁrea em cm²?',
         'figure':'rectangle','answer':'120',
         'hint':'Passo 1: c + l = 46÷2 = 23. Passo 2: c = l + 7 → 2l + 7 = 23 → l = 8. Passo 3: A = c × l',
         'explanation':'c + l = 23 e c = l + 7 → l = 8 cm, c = 15 cm. A = 15 × 8 = 120 cm²  (IFRN)','xp':15},
        {'id':2,'type':'fill_blank',
        ...
        {'id':3,'type':'fill_blank',
         'question':'IFSP 2016 — Uma praça pública em forma de circunferência tem raio de 18 m.\nUse π ≈ 3,14. Qual é a área da praça em m²?',
         'figure':'circle','answer':'1017.36','hint':'A = π × r² = 3,14 × 18²',
         'explanation':'A = π × r² = 3,14 × 18² = 3,14 × 324 = 1.017,36 m²  (IFSP 2016)','xp':15},
        {'id':4,'type':'fill_blank',
         'question':'A diagonal maior de um losango mede 15 cm e a diagonal menor é a terça parte da maior.\nQual é a área do losango em cm²?',
         'figure':'rhombus','answer':'37.5','hint':'d = 15 ÷ 3 = 5 cm. A = (D × d) / 2',
         'explanation':'d = 15 ÷ 3 = 5 cm. A = (15 × 5) / 2 = 75 / 2 = 37,5 cm²','xp':15},
        {'id':5,'type':'fill_blank',
         'question':'Uma janela CIRCULAR tem diâmetro = 1,2 m. Use π ≈ 3,14.\nQual é a área da janela em m², com 2 casas decimais?',
...
def q_5_3():
    ...
    return [
        {'id':1,'type':'fill_blank',
         'question':'Uma figura é formada por um RETÂNGULO com base 10 cm e altura 6 cm, com um TRIÂNGULO de base 10 cm e altura 4 cm no topo.\nQual é a área total em cm²?',
        ...
        {'id':2,'type':'fill_blank',
         'question':'Um terreno QUADRADO com lado 20 m tem uma piscina CIRCULAR com raio 5 m no centro. Use π ≈ 3,14.\nQual é a área do terreno FORA da piscina em m²?',
        ...
        {'id':4,'type':'fill_blank',
         'question':'Uma bandeira RETANGULAR de 60 cm × 40 cm tem um LOSANGO central com D=20 cm, d=12 cm.\nQual é a área da bandeira FORA do losango em cm²?',
        ...
        {'id':5,'type':'fill_blank',
         'question':'Um parque tem formato de TRAPÉZIO com base maior B = 50 m, base menor b = 30 m e altura h = 20 m, e dentro há um QUADRADO de lado l = 10 m.\nQual é a área verde fora do quadrado, em m²?',
...
def q_5_5():
    """Atividade 5.5 – Avaliação final com questões mistas (MC) — inclui CESGRANRIO e IFSP"""
    return [
        {'id':1,'type':'multiple_choice',
        ...
        {'id':3,'type':'multiple_choice',
         'question':'CESGRANRIO-RJ — [AVALIAÇÃO] As duas diagonais de um losango medem, respectivamente, 6 cm e 8 cm.\nQual é a área do losango?',
         'figure':'rhombus','options':['18 cm²','24 cm²','30 cm²','36 cm²'],'correct':1,
         'explanation':'A = (D × d) / 2 = (8 × 6) / 2 = 48 / 2 = 24 cm²  (CESGRANRIO-RJ)','xp':20},
        {'id':4,'type':'multiple_choice',
         'question':'IFSP 2016 — [AVALIAÇÃO] Uma praça pública em forma de circunferência tem raio de 18 metros.\nQual é a área da praça? Use π ≈ 3,14.',
         'figure':'circle','options':['1.017,36 m²','1.254,98 m²','1.589,77 m²','1.698,44 m²'],'correct':0,
         'explanation':'A = π × r² = 3,14 × 18² = 3,14 × 324 = 1.017,36 m²  (IFSP 2016)','xp':20},
        {'id':5,'type':'multiple_choice',
